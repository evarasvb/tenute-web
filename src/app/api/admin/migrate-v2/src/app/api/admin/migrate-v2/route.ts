...
-- ==============================================================
-- MIGRACION V2: Compras y Ventas Manuales
...
-- Tabla de Ventas Manuales (WhatsApp, telefono, caja)
...
-- Habilitar RLS (service_role lo bypasea automaticamente)
...
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json({
    ...
    instructions: 'Copia el SQL y ejecutalo en el editor de Supabase para habilitar las tablas de Compras y Ventas',
  });
}
