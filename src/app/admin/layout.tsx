...
const NAV_ITEMS = [
  ...
  { href: '/admin/analitica', label: 'Analítica', icon: 'M3 3v18h18M7 14l3-3 3 3 5-6M7 14v4m6-4v4m5-7v7' },
  { href: '/admin/importar', label: 'Importar', icon: 'M12 3v12m0 0l-4-4m4 4l4-4M4 17v2a2 2 0 002 2h12a2 2 0 002-2v-2' },
