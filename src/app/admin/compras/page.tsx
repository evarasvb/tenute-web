...
interface Product { id: string; name: string; sku: string|null; barcode: string|null; cost_price: number|null; image_url: string|null; stock_ocoa: number; stock_local21: number; }
