    ...
    <div className="space-y-6">
      ...
      <div className="card p-6">
        ...
        <div className="mt-6 space-y-3">
          <Link
            href="/checkout"
            className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-blue-600 text-white font-semibold text-sm hover:bg-blue-700 transition-colors"
          >
